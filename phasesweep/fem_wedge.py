...
from phasesweep.fem_field import _MU0
...
def _picard_solve_wedge(
    ...
    from phasesweep.fem_field import _MIN_PICARD_RELAX, _bh_nu
...
def compute_k_end(
    ...
    **kwargs,
    ...
    on the actuator). Not clamped — the >1 regime is real, not an artifact.
    ...
    below linear across 0–1 mm overhang on the actuator, from converged
