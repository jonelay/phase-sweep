...
from phasesweep.rated_torque import magnet_torque_constant, mtpa_gamma, mtpa_torque
...
def run_thermal_duty(config: RunConfig) -> dict[str, Any]:
    ...
    prediction. Budget-path and loss-mechanism
    caveats (AC copper, magnet eddy and friction/windage remain non-goals;
